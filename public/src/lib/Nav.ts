...
export const Nav:NavSection = {
    ...
    projects: {
        ...
        items: {
            ...
            digicrafter: {link: nav.projects.items.digicrafter.link, title: nav.projects.items.digicrafter.title, source: '/content/projects/UpdateLogs.tsx', disabled: true},
            kontakt: {link: nav.projects.items.kontakt.link, title: nav.projects.items.kontakt.title, source: '/content/Kontakt.tsx', disabled: true},
            beatportFilter: {link: nav.projects.items.beatportFilter.link, title: nav.projects.items.beatportFilter.title, source:'/content/MusicMixing.tsx', disabled: true},
            timers: {link: nav.projects.items.timers.link, title: nav.projects.items.timers.title, source: '/content/Timers.tsx', disabled: true},
            // : {link: nav, title: nav},
        }
    },
    music: {
        ...
        items: {
            ...
            mixing: {link: nav.music.items.mixing.link, title: nav.music.items.mixing.title, source:'/content/MusicMixing.tsx', disabled: true},
            // : {link: nav, title: nav},
        }
    },
    // blog: {
