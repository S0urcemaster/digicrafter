...
export default function  (props:{visible:boolean, setVisible:(visible:boolean) => void}) {
    ...
    return (
        ...
        >
            ...
            <p>DigiOps stands for 'Digital Operations' and is related to the term 'DevOps'.</p>
            ...
            <p>Don't write a wiki entry - write an operation that is doing what you'd just documented instead.
                ...
                you just look up for the operation you created, optionally make some changes to it and press "run".</p>
        </Modal>
    )
