...
export const Nav:NavSection = {
    ...
    projects: {
        ...
        items: {
            ...
            beatportFilter: {link: nav.projects.items.beatportFilter.link, title: nav.projects.items.beatportFilter.title, source:'/content/MusicMixing.tsx'},
    ...
    blog: {
        ...
        items: {
            mindDistraction: {link: nav.blog.items.mindDistraction.link, title: nav.blog.items.mindDistraction.title, source:'/content/MusicMixing.tsx'},
            // : {link: nav, title: nav},
        }
    },
    wiki: {
