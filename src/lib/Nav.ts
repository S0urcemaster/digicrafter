    ...
    tools: {
        ...
        items: {
            ...
            digiop: {link: nav.tools.items.digiop.link, title: nav.tools.items.digiop.title,
                source:['/content/tools/DigiOp.tsx', '/content/tools/digiop/Routines.tsx', '/content/tools/digiop/RoutineForm.tsx', '/content/tools/digiop/Brokers.tsx',
                    '/content/tools/digiop/JobList.tsx', '/components/ListNavigator.tsx', '/lib/digiop/Broker.ts']},
            routinePlanner: {link: nav.tools.items.routinePlanner.link, title: nav.tools.items.routinePlanner.title,
                source:[]},
