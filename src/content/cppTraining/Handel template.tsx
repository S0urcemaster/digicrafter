...
export default function Cpp210318 () {
    ...
    useEffect(() => {
        axios.get(host +'cpp/' +paths.main_cpp, {headers:{'Content-type':'text/plain;charset=ISO-8859-1'}})
            .then(res => {
                setMainCpp(res.data)
            }).catch(() => {
        })
        axios.get(host +'cpp/' +paths.kunde_h, {headers:{'Content-type':'text/plain;charset=ISO-8859-1'}})
            .then(res => {
                setKundeH(res.data)
            }).catch(() => {
        })
        axios.get(host +'cpp/' +paths.kunde_cpp, {headers:{'Content-type':'text/plain;charset=ISO-8859-1'}})
            .then(res => {
                setKundeCpp(res.data)
            }).catch(() => {
        })
        axios.get(host +'cpp/' +paths.bestellung_h, {headers:{'Content-type':'text/plain;charset=ISO-8859-1'}})
            .then(res => {
                setBestellungH(res.data)
            }).catch(() => {
        })
        axios.get(host +'cpp/' +paths.bestellung_cpp, {headers:{'Content-type':'text/plain;charset=ISO-8859-1'}})
            .then(res => {
                setBestellungCpp(res.data)
            }).catch(() => {
        })
        axios.get(host +'cpp/' +paths.artikel_h, {headers:{'Content-type':'text/plain;charset=ISO-8859-1'}})
            .then(res => {
                setArtikelH(res.data)
            }).catch(() => {
        })
        axios.get(host +'cpp/' +paths.artikel_cpp, {headers:{'Content-type':'text/plain;charset=ISO-8859-1'}})
            .then(res => {
